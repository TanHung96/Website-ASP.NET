...
namespace _5951071126_nguyenDangTanHung.Models
{
    public class db
    {
        SqlConnection con = new SqlConnection(@"Data Source=LAPTOP-SQL77HJC\SQLEXPRESS;Initial Catalog=DemoCRUD;Integrated Security=True");
